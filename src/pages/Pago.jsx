...
const Pago = () => {
    ...
    window.paypal
      .Buttons({
        ...
        createOrder: function (data, actions) {
          const valor = ((reserva.cotizacion || 1500) / 100).toFixed(2);
  ...
  // 8) Alternar entre “Tarjeta” y “PayPal”
              ...
              <div className="resumen-compra">
                ...
                <div className="resumen-card">
                  <div className="resumen-header">
                    <h3>{reserva.tipoReserva || "Individual"}</h3>
                    <span className="precio-resumen">
                      $
                      {(reserva.cotizacion || 1500).toLocaleString("es-MX")} MXN
                    </span>
                  </div>
